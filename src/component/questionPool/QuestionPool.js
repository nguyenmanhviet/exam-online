import classes from "./QuestionPool.module.css";
...
const QuestionPool = (props) => {
  ...
  const handleSearch = (event) => {
    ...
    fetch(
      `http://3.105.183.164:3001/question?q=${
  ...
  const handleChangePage = (page) => {
    ...
    headers.append("Access-Control-Allow-Origin", "http://3.105.183.164:3001");
    headers.append("Access-Control-Allow-Credentials", "true");
    fetch(`http://3.105.183.164:3001/question?page=${page}&q=${
      searchContent.current.value
    }&subjectId=${payload.subjectId ?? ""}`, {
      method: "GET",
      headers: headers,
  ...
  useEffect(() => {
    ...
    headers.append("Access-Control-Allow-Origin", "http://3.105.183.164:3001");
    headers.append("Access-Control-Allow-Credentials", "true");
    fetch(`http://3.105.183.164:3001/question`, {
      method: "GET",
      headers: headers,
    })
      .then((res) => res.json())
            ...
            <form>
              <div className={classes.searching}>
                ...
                <div className={classes.control}>
                  ...
                  <input type="text" placeholder="Học phần" ref={searchContent}/>
                </div>
              </div>
